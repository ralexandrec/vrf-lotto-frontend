export const translations = {
  pt: {
    ...
    "buy.installMetaMaskAlert": "Por favor, instale a MetaMask para interagir com o DApp!",
    "log.title": "ATIVIDADES EM TEMPO REAL",
    "log.tab.global": "Geral (Contrato)",
    "log.tab.user": "Minhas Ações",
  ...
  en: {
    ...
    "buy.installMetaMaskAlert": "Please install MetaMask to interact with the DApp!",
    "log.title": "LIVE ACTIVITY",
    "log.tab.global": "General (Contract)",
    "log.tab.user": "My Activity",
